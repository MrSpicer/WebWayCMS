...
/// <summary>
/// Helper for the Static-SSR Identity components: performs redirects (which must throw to abort
/// rendering) and carries a one-shot status message across the redirect via a cookie. Adapted from
/// the standard ASP.NET Core Blazor Web App (Individual Accounts) template.
/// </summary>
